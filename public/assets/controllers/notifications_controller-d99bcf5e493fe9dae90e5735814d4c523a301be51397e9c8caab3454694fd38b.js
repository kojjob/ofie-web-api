...
export default class extends Controller {
  ...
  connect() {
    ...
    // Add outside click listener with slight delay to avoid conflicts
  ...
  handleOutsideClick(event) {
    if (!this.element.contains(event.target) && this.hasDropdownTarget && !this.dropdownTarget.classList.contains('hidden')) {
      this.close()
    }
  }
