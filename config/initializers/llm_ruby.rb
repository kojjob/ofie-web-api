...
begin
  ...
  Rails.logger.warn "[LLM Configuration] LLM gem not available: #{e.message}. AI lease generation features will be disabled."
rescue StandardError => e
  Rails.logger.error "[LLM Configuration] Error initializing LLM: #{e.message}"
